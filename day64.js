...
longestWord('hi im suraj are you suraj let play dddddddddddd');
...
//     for (let j = i + 1; j < arr.length; j++) {
//       if (arr[i] + arr[j] === target) {
//         return [arr[i], arr[j]]; // or return [i, j]
//       }
//     }
//   }
//   return null;
...
//     let consant = s.match(/[bcdfghjklmnpqrstvwxyz]/g);
//     console.log(consant)
...
// ReplaceSpaceWithHyphen('suraj is good')
...
// console.log(secondMax([10, 5, 20, 8]));

//3

// function checkarraysorted(arr){
//     let flag = true; // assume sorted
